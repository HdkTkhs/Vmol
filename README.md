...
build a QM/MM simulator[2] in the early stage of the development. However, current release only includes the original MPI-parallelized Kohn Sham-DFT[4] module extracted from the integrated code. Thus, only the core of the 'Vmol' has been placed on GitHub. 
